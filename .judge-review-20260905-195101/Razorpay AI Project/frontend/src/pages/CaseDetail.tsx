...
import { VoiceRecoveryPanel } from '../components/VoiceRecoveryPanel';
...
export default function CaseDetail() {
  ...
  return (
    <div>
      ...
      {/* Consent-Based Hinglish Voice Recovery Agent */}
      <VoiceRecoveryPanel
        caseId={cas.case_id}
        amountInr={ctx.amount_inr}
        customerName={ctx.customer_name || ctx.customer_id}
