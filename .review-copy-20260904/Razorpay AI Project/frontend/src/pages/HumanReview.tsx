  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Review high-value subscriptions, degraded bank scenarios, and low-confidence model predictions"
        actions={
      ...
      <Alert
        message="Human-in-the-Loop Safety Boundary"
        description="Cases appear here when AI confidence is low (< 0.70), subscription value is high (> ₹10,000), or bank is in degraded mode. Approved actions are dispatched immediately via test mode."
        type="info"
        showIcon
      ...
      {error ? (
        ...
        <EmptyState
          message="No cases currently awaiting human approval! The review queue is clear."
          action={
