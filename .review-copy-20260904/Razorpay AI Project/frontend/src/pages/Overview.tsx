  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Real-time autonomous subscription payment recovery metrics & AI decision trace"
        actions={
          <Space>
            <Button
          ...
          <Row gutter={[16, 16]} className="mb-6">
            <Col xs={24} sm={12} lg={6}>
              <KpiCard
                ...
                sub="Subscription failures detected"
            ...
            <Col xs={24} sm={12} lg={6}>
              <KpiCard
                ...
                sub={`${metrics.recovery_rate != null ? (metrics.recovery_rate * 100).toFixed(1) : '0.0'}% overall recovery rate`}
            ...
            <Col xs={24} sm={12} lg={6}>
              <KpiCard
                ...
                sub="Policy & guardrail flagged cases"
          ...
          <Row gutter={[16, 16]} className="mb-6">
            <Col xs={24} lg={16}>
              <Card
                title={
                  <div>
                    <span className="font-semibold text-slate-800">Recovery Trend Analysis</span>
                    <p className="text-xs text-slate-500 font-normal m-0 mt-0.5">
                      Cumulative recovered payment volume: AI Autopilot vs Fixed Baseline
                    </p>
                  </div>
                }
              >
              ...
              >
                {metrics.recent_audits.length === 0 ? (
                  <div className="py-12 text-center text-slate-400 text-xs">
                    No recent audit events.<br />Click "Seed Demo Data" to populate.
                  </div>
                ) : (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-slate-500 m-0 mt-1">
                    Filter by failure codes, customer telemetry & execution status
                  </p>
                </div>
            ...
            <Col xs={24} md={8}>
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-slate-500 m-0 mt-1">
                    Review and approve high-value or safety-flagged interventions
                  </p>
                </div>
              ...
              >
                <div>
                  <h4 className="font-semibold text-slate-900 m-0 group-hover:text-purple-600 transition-colors">
                    Benchmark & Experiment Lab
                  </h4>
                  <p className="text-xs text-slate-500 m-0 mt-1">
                    Run 500-case randomized evaluation against fixed-rule baselines
                  </p>
                </div>
