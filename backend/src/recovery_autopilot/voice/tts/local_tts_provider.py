...
VOICE_REGISTRY: List[VoiceProfile] = [
    VoiceProfile(
        ...
        sample_rate=24000,
        naturalness_score=4.9,
        description="Clear, professional conversational tone for fintech and payment recovery.",
    ),
    VoiceProfile(
        ...
        gender=VoiceGender.FEMALE,
        sample_rate=24000,
        naturalness_score=4.85,
        description="Warm, polite conversational Hindi with natural cadence.",
    ),
    VoiceProfile(
        ...
        description="Native Kannada voice tuned for respectful customer assistance.",
    ),
    VoiceProfile(
        ...
        description="Authentic Tamil speaker with clear articulation of payment links and dates.",
    ),
    VoiceProfile(
        ...
        gender=VoiceGender.FEMALE,
        sample_rate=24000,
        naturalness_score=4.81,
        description="Expressive Telugu voice for debt resolution and payment confirmation.",
    ),
    VoiceProfile(
        ...
        gender=VoiceGender.FEMALE,
        sample_rate=24000,
        naturalness_score=4.78,
        description="Standard Marathi voice with accurate banking terminology pronunciation.",
    ),
    VoiceProfile(
        ...
        gender=VoiceGender.FEMALE,
        sample_rate=24000,
        naturalness_score=4.83,
        description="Gentle, natural Bengali voice for empathetic customer engagement.",
    ),
]


class LocalMultilingualTTSProvider(BaseTTSProvider):
    """Local high-fidelity acoustic TTS engine with locale-aware speech synthesis."""
