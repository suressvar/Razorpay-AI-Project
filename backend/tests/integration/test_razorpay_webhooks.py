...
def test_map_payment_captured_fixture():
    ...
    captured = RazorpayEventMapper.map_payment_captured(payload)
    assert captured.payment_id == "pay_captured_test_01"
    assert captured.amount_inr == 2999.00
...
def test_map_order_paid_fixture():
    ...
    captured = RazorpayEventMapper.map_payment_captured(payload)
    assert captured.payment_id == "pay_order_paid_01"
    assert captured.amount_inr == 2999.00
